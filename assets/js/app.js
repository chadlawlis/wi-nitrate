...
(function () {
  ...
  map.on('load', function () {
    ...
    '<p>Once interpolation is complete, OLS regression is calculated using nitrate concentration as the independent variable and cancer rate as the dependent variable to generate a predicted cancer rate for each hexbin.</p>' +
